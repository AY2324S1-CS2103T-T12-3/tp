...
1. The user interface should be intuitive enough for users who are not IT-savvy
2. The product should be for a single user
3. The software should work without requiring an installer.
4. The GUI should work well for standard resolutions
5. The file sizes of the deliverables should be reasonable and not exceed the limits given below.
